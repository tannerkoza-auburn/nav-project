...
for i = 2:numSamplesIMU
    ...
    wBI_B = Csb * data.imu.angular_velocity(i, :)';% + 0.1*randn(3,1);
    fBI_B = Csb * data.imu.linear_acceleration(i, :)';%+ 0.1*randn(3,1);
    ...
    insVelocityNED = vel_update(fBI_N, insVelocityNED, omegaEI_N, omegaNE_N, gravityNED, dt);
